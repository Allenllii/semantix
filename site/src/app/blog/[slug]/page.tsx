...
export async function generateMetadata({ params }: BlogPageProps): Promise<Metadata> {
  ...
  return post ? { title: `${post.title} | Semantix`, description: post.description } : {};
}
      ...
      <div className="mx-auto grid max-w-[1120px] gap-14 xl:grid-cols-[minmax(0,780px)_220px]">
        <div className="min-w-0">
          <div className="mb-9 border-b border-border pb-7">
            ...
            <time dateTime={post.updated} className="mt-5 block font-mono text-xs text-muted-foreground">Last updated · {post.updated}</time>
          </div>
