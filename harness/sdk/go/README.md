# Semantix Extension SDK for Go

Write [Semantix](https://github.com/Gnosil/semantix) extensions in
Go. An extension is a small sidecar process speaking **Extension Protocol
v2** (`semantix.extension.v2`) over stdio: Semantix launches it, hands it the
...
```sh
go get github.com/Gnosil/semantix/harness/sdk/go@v1.0.0
```
...
import (
	...
	extension "github.com/Gnosil/semantix/harness/sdk/go"
)
...
cp ./examples/fullsidecar/semantix-plugin.json /tmp/full-sidecar/
...
the binary interactively. It is installed into a temporary Semantix home and
driven end-to-end against the real host by `internal/extension/conformance` in
the Semantix repository.
