...
func TestDisableDiscoveryReturnsEmptyStore(t *testing.T) {
	...
	project := t.TempDir()
	custom := t.TempDir()
	writeSkill(t, home, ".semantix/skills/global.md", "---\ndescription: global\n---\nbody")
	writeSkill(t, project, ".semantix/skills/project.md", "---\ndescription: project\n---\nbody")
...
func TestListPrecedenceProjectOverGlobal(t *testing.T) {
	home := t.TempDir()
	proj := t.TempDir()
	writeSkill(t, proj, ".semantix/skills/greet.md", "---\nname: greet\ndescription: project greet\n---\nproject body")
	writeSkill(t, home, ".semantix/skills/greet.md", "---\ndescription: global greet\n---\nglobal body")
	writeSkill(t, home, ".semantix/skills/onlyglobal.md", "---\ndescription: only global\n---\nbody")
...
func TestPluginSkillShortAliasIsHiddenAndProjectSkillKeepsShortName(t *testing.T) {
	...
	writeSkill(t, project, ".semantix/skills/plan/SKILL.md", "---\ndescription: project plan\n---\nPROJECT")
...
func TestFlatAndDirLayout(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/flat.md", "---\ndescription: flat\n---\nflat body")
	writeSkill(t, home, ".semantix/skills/dir/SKILL.md", "---\ndescription: dir\n---\ndir body")
...
func TestNestedSkillsDiscoveredByDefault(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/superpower/skill-a.md", "---\ndescription: nested flat\n---\nflat body")
	writeSkill(t, home, ".semantix/skills/superpower/tool-a/SKILL.md", "---\ndescription: nested dir\n---\ndir body")
	writeSkill(t, home, ".semantix/skills/superpower/references/notes.md", "---\ndescription: not a skill\n---\nnotes")
...
func TestNestedSkillsRequireDescription(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/root.md", "---\n---\nroot body")
	writeSkill(t, home, ".semantix/skills/superpower/draft.md", "---\n---\ndraft body")
	writeSkill(t, home, ".semantix/skills/superpower/tool/SKILL.md", "---\n---\ntool body")
...
func TestNestedDirectorySkillStopsTraversal(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/pack/SKILL.md", "---\ndescription: pack\n---\npack body")
	writeSkill(t, home, ".semantix/skills/pack/child.md", "---\ndescription: child\n---\nchild body")
...
func TestSemantixHomeDirOverridesGlobalSemantixSkills(t *testing.T) {
	home := t.TempDir()
	semantixHome := filepath.Join(t.TempDir(), "rx-home")
	writeSkill(t, home, ".semantix/skills/old.md", "---\ndescription: old\n---\nold")
	writeSkill(t, home, ".semantix/skills/current.md", "---\ndescription: old current\n---\nold current")
	currentPath := writeSkill(t, semantixHome, "skills/current.md", "---\ndescription: current\n---\ncurrent")

	st := New(Options{HomeDir: home, SemantixHomeDir: semantixHome, DisableBuiltins: true})
	list := st.List()
	current, ok := find(list, "current")
	if !ok {
		t.Fatal("Semantix home skill should be discovered")
	}
	if current.Path != currentPath {
		t.Fatalf("current skill path = %q, want Semantix home path %q", current.Path, currentPath)
	}
	if _, ok := find(list, "old"); !ok {
		t.Fatal("legacy ~/.semantix-agent skill should remain discoverable")
	}
	...
	want := filepath.Join(semantixHome, SkillsDirname, "created", SkillFile)
	if path != want {
...
func TestExcludedPathsHideConventionRoots(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/keep.md", "---\ndescription: keep\n---\nb")
...
func TestFrontmatterFields(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/sub.md",
		"---\ndescription: a sub\nrunAs: subagent\nallowed-tools: read_file, grep\nmodel: deepseek-pro\nread-only: true\n---\nbody")
	writeSkill(t, home, ".semantix/skills/fork.md", "---\ndescription: f\ncontext: fork\n---\nbody")
	writeSkill(t, home, ".semantix/skills/plain.md", "---\ndescription: p\n---\nbody")
...
func TestReferencesInlined(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/withrefs/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeSkill(t, home, ".semantix/skills/withrefs/references/b.md", "second ref")
	writeSkill(t, home, ".semantix/skills/withrefs/references/a.md", "first ref")
...
func TestScriptsAppended(t *testing.T) {
	...
	writeSkill(t, home, ".semantix/skills/withscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeScript(t, home, ".semantix/skills/withscripts/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')")
	writeScript(t, home, ".semantix/skills/withscripts/scripts/deploy.sh", "#!/usr/bin/env bash\necho ok")
...
func TestNoScriptsWhenDirAbsent(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/noscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	st := New(Options{HomeDir: home, DisableBuiltins: true})
...
func TestScriptsFilteredByExt(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/scriptscheck/SKILL.md", "---\ndescription: t\n---\nbody")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')\n")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/.hidden.py", "")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/readme.md", "# readme")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/deploy", "#!/bin/sh\necho ok")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/legacy.p", "print 'ok'\n")
	writeScript(t, home, ".semantix/skills/scriptscheck/scripts/.gitkeep", "")
...
func TestBuiltinsPresentAndOverridable(t *testing.T) {
	...
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/explore.md", "---\ndescription: mine\nrunAs: inline\n---\nbody")
...
func TestDisabledSkillsAreFilteredFromListAndRead(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/active.md", "---\ndescription: active\n---\nbody")
	writeSkill(t, home, ".semantix/skills/hidden.md", "---\ndescription: hidden\n---\nbody")
...
func TestInvalidNamesSkipped(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/bad name.md", "---\ndescription: x\n---\nb") // space → invalid
	st := New(Options{HomeDir: home, DisableBuiltins: true})
	if len(st.List()) != 0 {
...
func TestSymlinkedDirAndFile(t *testing.T) {
	...
	skillsRoot := filepath.Join(home, ".semantix", "skills")
...
func TestColorFrontmatterParses(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/tagged.md", "---\ndescription: has a color\ncolor: amber\n---\nbody")
...
func TestManualInvocationSkillExcludedFromIndex(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".semantix/skills/private-agent.md", "---\ndescription: my private subagent\nrunAs: subagent\ninvocation: manual\n---\nbody")
	writeSkill(t, home, ".semantix/skills/public-agent.md", "---\ndescription: a discoverable subagent\nrunAs: subagent\n---\nbody")
...
func TestCreateRefusesOverwrite(t *testing.T) {
	...
	if !strings.HasSuffix(path, filepath.Join(".semantix", "skills", "mine", SkillFile)) {
	...
	writeSkill(t, home, ".semantix/skills/legacy.md", "---\ndescription: legacy\n---\nbody")
