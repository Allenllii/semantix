...
var Chinese = Messages{
	...
	ArgEffortMax:        "最高推理",
	ArgEffortNone:       "无推理",
	ArgEffortDisabled:   "推理已关闭",
	ArgEffortEnabled:    "推理已开启",
	ArgEffortAdaptive:   "按请求自适应推理",
	ArgEffortGeneric:    "提供方上报的 effort 档位",
	ArgThemeCurrent:     "当前",
	...
	EffortListHint:               "用 /effort <档位> 切换（auto 表示显式采用已配置的默认值）",
	...
	WorkModeListHint:             "使用 /work light|balanced|delivery 切换（/preset、/work-mode、/profile 为兼容别名）",
	...
	WorkModeDeprecatedNotice:     "提示：/work-mode 与 /profile 已弃用，请使用 /work light|balanced|delivery",
	RewindNone:                   "暂无可回滚的内容",
