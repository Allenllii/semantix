...
// $LC_ALL / $SEMANTIX_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that SEMANTIX_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("SEMANTIX_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("SEMANTIX_LANG=en overriding LANG=zh: got %q, want en", got)
	}
