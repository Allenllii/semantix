...
import (
	...
	"semantix/harness/extension/providerext"
...
func TestBootFirstBootPluginDefaultModelStreams(t *testing.T) {
	...
	installProviderFake(t, config.SemantixHomeDir(), name, nil)
...
func TestBootUnknownPluginRefListsAvailableRefs(t *testing.T) {
	...
	installProviderFake(t, config.SemantixHomeDir(), "providerdemo", nil)
...
func TestBootStartsExtensionPackagesOncePerBuild(t *testing.T) {
	...
	t.Chdir(dir)
	writeRuntimeFixture(t, dir)
	installBootFakePlugin(t, config.SemantixHomeDir(), "counted", map[string]any{})
...
func TestBootRedactsExtensionStartupWarnings(t *testing.T) {
	...
	t.Chdir(dir)
	writeRuntimeFixture(t, dir)
	installBootFakePlugin(t, config.SemantixHomeDir(), "warning-source", map[string]any{})
...
func TestBootRequiredExitLeavesNoSidecarProcess(t *testing.T) {
	...
	installBootFakePlugin(t, config.SemantixHomeDir(), "required-dies", map[string]any{
		"required": true,
		"env": map[string]string{
...
func TestBootProviderConflictLeavesNoSidecarProcess(t *testing.T) {
	...
	pidFile := filepath.Join(dir, "sidecar.pid")
	installProviderFake(t, config.SemantixHomeDir(), name, map[string]string{
		bootFakeEnvPIDFile: pidFile,
	})
...
func TestRebuildPluginPreflightFailureKeepsOldRuntime(t *testing.T) {
	...
	t.Chdir(dir)
	writeRuntimeFixture(t, dir)
	installBootFakePlugin(t, config.SemantixHomeDir(), "stable", map[string]any{})
