...
//   - under Semantix home → <semantix-home>/...
//   - under OS home → ~/...
//   - elsewhere → <external>/basename (no full external path, no username)
func displayPath(p, workspace, home, semantixHome string) string {
