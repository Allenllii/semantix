...
// free of cache/state side effects under Semantix home.
func probeLiveMCP(rep *MCPReport, cfg *config.Config, root, home, semantixHome string, timeout time.Duration) []Issue {
	var issues []Issue
	if cfg == nil {
		return issues
	}
