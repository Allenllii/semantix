...
//  1. does DeepSeek's auto cache actually serve semantix's request shape, and how
...
func TestRealDeepSeekCacheProbe(t *testing.T) {
	...
	// noR exercises Semantix's empty-key recovery fallback. Warm each prefix once,
