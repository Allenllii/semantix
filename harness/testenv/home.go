...
// IsolateUserState redirects default user-scoped Semantix paths to a disposable
...
func IsolateUserState() (func(), error) {
	...
	home, err := os.MkdirTemp(originalHome, ".semantix-test-home-*")
	if err != nil && originalHome != "" {
		home, err = os.MkdirTemp("", "semantix-test-home-*")
	}
	if err != nil {
