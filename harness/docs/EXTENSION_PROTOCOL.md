# Semantix Extension Protocol v2

The Extension Protocol is the stable wire contract between Semantix (the
...
- Protocol ID: `semantix.extension.v2`
...
A code extension is **full trust**: it runs outside the Semantix sandbox
