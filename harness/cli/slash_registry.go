...
func builtinSlashSpecs() []builtinSlashSpec {
	return []builtinSlashSpec{
		...
		{name: "/work", aliases: []string{"/preset", "/work-mode", "/profile"}, insert: "/work ", hint: i18n.M.CmdWorkMode, descend: true, showInHelp: true},
		...
		{name: "/docs", aliases: []string{"/semantix:docs"}, insert: "/docs ", hint: i18n.M.CmdDocs, showInHelp: true},
