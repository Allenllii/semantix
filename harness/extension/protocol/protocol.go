...
// the Semantix host and out-of-process extension sidecars. It is a public
// protocol: sidecars are written against this package's generated JSON Schema
// and its compatibility hash, not against Semantix internals.
//
...
//
// The sidecar process is the "extension" peer; Semantix is the "host" peer.
// Directions are named from the host's point of view: host_to_extension_*
// flows from Semantix to the sidecar, extension_to_host_* flows back.
package protocol
...
const ProtocolID = "semantix.extension.v2"
