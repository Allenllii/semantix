...
// (<Semantix home>/plugin-packages.json) AND currently enabled. The launch
...
//
// FULL-TRUST CONTRACT: a sidecar process inherits the UNFILTERED Semantix
// environment (os.Environ), plus its manifest env and SEMANTIX_PLUGIN_ROOT /
// SEMANTIX_PLUGIN_NAME / SEMANTIX_PLUGIN_VERSION. Sidecars can read
