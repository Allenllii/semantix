// Package netclient builds HTTP clients and proxy resolvers that share Semantix's
...
// NewHTTPClient returns an HTTP client with Semantix proxy settings applied.
