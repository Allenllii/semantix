...
const (
	...
	refImage                   // a local image attachment: @.semantix/attachments/<file>
)
...
const externalFolderRefPrefix = "__semantix_external_folder"
...
func isAttachmentRef(token string) bool {
	return strings.HasPrefix(filepath.ToSlash(token), ".semantix/attachments/")
}
...
// text rather than a Semantix slash command.
